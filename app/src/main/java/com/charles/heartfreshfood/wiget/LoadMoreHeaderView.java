...
import medusa.theone.waterdroplistview.view.WaterDropView;

public class LoadMoreHeaderView extends FrameLayout {
    private LinearLayout mContainer;
    private ProgressBar mProgressBar;
    private medusa.theone.waterdroplistview.view.WaterDropView mWaterDropView;
     ...
     * @param attrs
     */
    public LoadMoreHeaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
